...
namespace FFIECPublicWebServiceSampleClient.FFIECPublicWebService
{
    using System.Diagnostics;
    using System.Web.Services;
    using System.ComponentModel;
    ...
    public partial class RetrievalService : Microsoft.Web.Services3.WebServicesClientProtocol
    {
        ...
        {
            this.Url = "https://test.cdr.ffiec.gov/publicif/pws/WebServices/RetrievalService.asmx";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginTestUserAccess(System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("TestUserAccess", new object[0], callback, asyncState);
        }

        /// <remarks/>
        public bool EndTestUserAccess(System.IAsyncResult asyncResult)
        {
        ...
        public System.IAsyncResult BeginRetrieveReportingPeriods(ReportingDataSeriesName dataSeries, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RetrieveReportingPeriods", new object[] {
                    dataSeries}, callback, asyncState);
        }

        /// <remarks/>
        public string[] EndRetrieveReportingPeriods(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((string[])(results[0]));
        }
        ...
        public System.IAsyncResult BeginRetrievePanelOfReporters(ReportingDataSeriesName dataSeries, string reportingPeriodEndDate, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RetrievePanelOfReporters", new object[] {
                    dataSeries,
                    reportingPeriodEndDate}, callback, asyncState);
        }

        /// <remarks/>
        public ReportingFinancialInstitution[] EndRetrievePanelOfReporters(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((ReportingFinancialInstitution[])(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRetrieveFilersSubmissionDateTime(ReportingDataSeriesName dataSeries, string reportingPeriodEndDate, string lastUpdateDateTime, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RetrieveFilersSubmissionDateTime", new object[] {
                    dataSeries,
                    reportingPeriodEndDate,
                    lastUpdateDateTime}, callback, asyncState);
        }

        /// <remarks/>
        public RetrieveFilersDateTime[] EndRetrieveFilersSubmissionDateTime(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((RetrieveFilersDateTime[])(results[0]));
        }
        ...
        /// <remarks/>
        public int[] EndRetrieveFilersSinceDate(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((int[])(results[0]));
        }
        ...
        public System.IAsyncResult BeginRetrieveFacsimile(ReportingDataSeriesName dataSeries, string reportingPeriodEndDate, FinancialInstitutionIDType fiIDType, int fiID, FacsimileFormat facsimileFormat, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RetrieveFacsimile", new object[] {
                    ...
                    fiIDType,
                    fiID,
                    facsimileFormat}, callback, asyncState);
        }

        /// <remarks/>
        public byte[] EndRetrieveFacsimile(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((byte[])(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRetrieveUBPRReportingPeriods(System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RetrieveUBPRReportingPeriods", new object[0], callback, asyncState);
        }

        /// <remarks/>
        public string[] EndRetrieveUBPRReportingPeriods(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((string[])(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRetrieveUBPRXBRLFacsimile(string reportingPeriodEndDate, FinancialInstitutionIDType fiIDType, int fiID, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RetrieveUBPRXBRLFacsimile", new object[] {
                    reportingPeriodEndDate,
                    fiIDType,
                    fiID}, callback, asyncState);
        }

        /// <remarks/>
        public byte[] EndRetrieveUBPRXBRLFacsimile(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((byte[])(results[0]));
        }
