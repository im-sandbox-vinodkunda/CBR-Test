    ...
    var getLoggedInUserDetails = function () {
        ...
        $http(req).then(function (result) {
            if (result.data !== null) {
                ...
                document.getElementById('overlay').style.display = 'none';
                dlg = dialogs.error('An error occurred while trying to get your details. Please send an e-mail to admin@cb-resource.com.');
            }
        }, function () {
            document.getElementById('overlay').style.display = 'none';
            dlg = dialogs.error('An error occurred while trying to get your details. Please send an e-mail to admin@cb-resource.com.');
    ...
    var getRatesLastUpdatedDate = function () {
        ...
        $http(req).then(function (result) {
            if (result.data !== null) {
                ...
                document.getElementById('overlay').style.display = 'none';
                dlg = dialogs.error('An error occurred while trying to get date when rates were last updated. Please send an e-mail to admin@cb-resource.com.');
            }
        }, function () {
            document.getElementById('overlay').style.display = 'none';
            dlg = dialogs.error('An error occurred while trying to get date when rates were last updated. Please send an e-mail to admin@cb-resource.com.');
