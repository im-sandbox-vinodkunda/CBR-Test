cbrBankAnalyticsModule.controller("profileOverviewViewModel", ["$scope", "$q", "$http", "$location", "$routeParams", "$window", "$rootScope", "$filter", "$interval", function ($scope, $q, $http, $location, $routeParams, $window, $rootScope, $filter, $interval) {
    ...
    $scope.getChartImagePresence = function (exportfile) {
        ...
        $http(req).then(function (result) {
            ...
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to check availability of chart images on export server. Please send an e-mail to admin@cb-resource.com.');
        });
    }
    ...
    $scope.MakeDefault = function ($event) {
        ...
        $http(req).then(function (result) {
            ...
            if (result.data != null && result.data === true) {
                ...
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to make the bank your default bank or this bank is already your default bank. Please send an e-mail to admin@cb-resource.com.');
            }
        }, function () {
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to make the bank your default bank. Please send an e-mail to admin@cb-resource.com.');
            document.getElementById('overlay').style.display = 'none';
        });
    }
    ...
    var DownloadPdf = function () {
        ...
        var req = {
            ...
            failCallback: function (responseHtml, url, error) {
                document.getElementById('overlay').style.display = 'none';
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to download the PDF. Please send an e-mail to admin@cb-resource.com.');
            },
            cookiePath: '/',
    ...
    var getPieChartData = function () {
        ...
        $http(req).then(function (result) {
            ...
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to get load composition and deposit composition chart data. Please send an e-mail to admin@cb-resource.com.');
        });
    }
    ...
    var getBarChartData = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get chart data for asset growth, loans growth, deposit growth and equity capital growth. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getYearToDateHeaders = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get YTD headers for table. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getQuarterToDateHeaders = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get QTD headers for table. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getBankProfileIntroductionData = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get basic data about the bank. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getBankProfileData = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get bank profile data. Please send an e-mail to admin@cb-resource.com.');
            });
    }
