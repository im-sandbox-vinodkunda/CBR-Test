...
cbrBankAnalyticsModule.controller("riskProfileCreditRiskViewModel", ["$scope", "$q", "$http", "$location", "$routeParams", "$window", "$rootScope", "$filter", function ($scope, $q, $http, $location, $routeParams, $window, $rootScope, $filter) {
    ...
    var getQuarterToDateHeaders = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to fetch headerrs for QTD table. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getCreditRiskChartData = function (rowData, chartType, custPeerGroupKey) {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get data for chart data. Please send an e-mail to admin@cb-resource.com.');
            });
    }
