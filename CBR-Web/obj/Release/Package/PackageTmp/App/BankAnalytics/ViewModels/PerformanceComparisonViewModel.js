cbrBankAnalyticsModule.controller("performanceComparisonViewModel", ["$scope", "$q", "$http", "$location", "$routeParams", "$window", "$rootScope", "$filter", function ($scope, $q, $http, $location, $routeParams, $window, $rootScope, $filter) {
    ...
    $scope.AddToFavorite = function ($event) {
        ...
        $http(req).then(function (result) {
            ...
            alert('An error occurred while trying to add the bank as favorite bank. Please send an e-mail to admin@cb-resource.com.');
            document.getElementById('overlay').style.display = 'none';
        });
    }
    ...
    $scope.SaveAsFavoriteSearch = function () {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to save favorite search criteria. Please send an e-mail to admin@cb-resource.com.');
                document.getElementById('overlay').style.display = 'none';
            });
    }
    ...
    var getFavoriteSearchesForUser = function () {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get favorite search criteria for you. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    $scope.RefreshTopBottomBanksOnKpi = function ($event, metric) {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get top/bottom performaing banks for selected KPI. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getBankPerformanceMetricData = function (institutionKey, location, assetSize, percentile) {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get bank performance metrices. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getBankPerformanceIntroData = function (certNumber) {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get bank performance data by bank FDIC number. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getBottomPerformingBankHeaders = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get top performing bank. Please send an e-mail to admin@cb-resource.com.');
            });
    }
    ...
    var getTopPerformingBankHeaders = function () {
        ...
        $http(req).then(function (result) {
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get bottom performing bank. Please send an e-mail to admin@cb-resource.com.');
            });
    }
