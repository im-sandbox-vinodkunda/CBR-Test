...
{
    public class CramCalculationsCet1
    {
        ...
        public static CramAdjustBankDataParams AdjustBankData
        {
            ...
            set
            {
                CramCalculationsCet1.adjustBankData = value;
            }
        }
        public static CramRiskCategoriesParams RiskCategoriesAndWeights
        {
            ...
            set
            {
                CramCalculationsCet1.riskCategoriesAndWeights = value;
            }
        }
        public static CramRiskRatingsParams RiskRating
        {
            ...
            set
            {
                CramCalculationsCet1.riskRating = value;
            }
        }
        public static CramDefaultRatings DefaultRatings
        {
            ...
            set
            {
                CramCalculationsCet1.defaultRiskRating = value;
            }
        }
        public static CramDashboardConcepts SelectedBankVitals
        {
            ...
            set
            {
                CramCalculationsCet1.cramDashboardConcepts = value;
            }
        }
        ...
        public static Decimal? BanksCet1CapitalRatioWeightedRiskBuffer()
        {
        ...
        public static Decimal? RiskAssessBufferCet1CapitalLessImpliedMinWeightedRiskBuffer()
        {
            return Convert.ToDecimal(BanksCet1CapitalRatioWeightedRiskBuffer()) - Convert.ToDecimal(ImpliedMinimumWeightedRiskBuffer());
        }
        ...
        public static Decimal? Cet1CapitalLessBanksMinimumWeightedRiskBuffer()
        {
            return BanksCet1CapitalRatioWeightedRiskBuffer() - BanksMinimumWeightedRiskBuffer();
        }

        public static Decimal? ActualCet1CapitalRatioWeightedRiskBuffer()
        {
            return Convert.ToDecimal(RegulatoryMinimumWeightedRiskBuffer()) +
                ...
                Convert.ToDecimal(Cet1CapitalLessBanksMinimumWeightedRiskBuffer());
        }
        ...
        public static Decimal? BanksCet1CapitalRatioCapital()
        {
            if (AdjustBankData.TotalRiskWeightedAssets == null)
            {
                return Convert.ToDecimal(SelectedBankVitals.TotalRiskWeightedAssets) * Convert.ToDecimal(BanksCet1CapitalRatioWeightedRiskBuffer() / 100);
            }
            else
            {
                return Convert.ToDecimal(AdjustBankData.TotalRiskWeightedAssets) * Convert.ToDecimal(BanksCet1CapitalRatioWeightedRiskBuffer() / 100);
            }
        }

        public static Decimal? RiskAssessBufferCet1CapitalLessImpliedMinCapital()
        {
            if (AdjustBankData.TotalRiskWeightedAssets == null)
            {
                return Convert.ToDecimal(SelectedBankVitals.TotalRiskWeightedAssets) * Convert.ToDecimal(RiskAssessBufferCet1CapitalLessImpliedMinWeightedRiskBuffer() / 100);
            }
            else
            {
                return Convert.ToDecimal(AdjustBankData.TotalRiskWeightedAssets) * Convert.ToDecimal(RiskAssessBufferCet1CapitalLessImpliedMinWeightedRiskBuffer() / 100);
            }
        }
        ...
        public static Decimal? Cet1CapitalLessBanksMinimumCapital()
        {
            return BanksCet1CapitalRatioCapital() - BanksMinimumCapital();
        }

        public static Decimal? ActualCet1CapitalRatioCapital()
        {
            Decimal? sum = Convert.ToDecimal(RegulatoryMinimumCapital()) +
                Convert.ToDecimal(BufferImpliedMinimumCapital()) +
                Convert.ToDecimal(BufferBanksMinimumCapital()) +
                Convert.ToDecimal(Cet1CapitalLessBanksMinimumCapital());

            //$broadcast("CalculationsCompleteCet1LeverageRatio", "Calculations Complete");
            return sum;
        }
    }
}
