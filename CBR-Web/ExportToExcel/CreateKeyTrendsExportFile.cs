...
{
    class CreateKeyTrendsExportFile
    {
        ...
        private static void WriteDataTableToExcelWorksheet(DataTable dt, WorksheetPart worksheetPart, BankProfileIntroductionData Bankfinalres)
        {
            ...
            if (dt.TableName != "Information")
            {
                ...
                AppendTextCell(excelColumnNames[0] + "1", "KEY RISK TRENDS", headerRow1, 8);
        ...
        private static DocumentFormat.OpenXml.UInt32Value GetSheetStyle(string cellValue)
        {
            ...
            else if (cellValue.Equals("CreditAllowance"))
            {
                k = 1;
            }
            ...
            else if (cellValue.Equals("LoanMix"))
            {
                k = 1;
            }
            ...
            else if (cellValue.Equals("PastDue"))
            {
                k = 1;
            }
            ...
            else if (cellValue.Equals("InterestRateRiskItems"))
            {
                k = 1;
            }
            ...
            else if (cellValue.Equals("CommercialRealEstate"))
            {
                k = 1;
            }
            else if (cellValue.Equals("MarginAnalysis"))
            {
                k = 1;
            }
            else if (cellValue.Equals("GrowthRates"))
            {
                k = 1;
            }
            else if (cellValue.Equals("KeyLiquidityRatios"))
            {
                k = 1;
            }
            else if (cellValue.Equals("LiquiditySecurityRatios"))
            {
                k = 1;
            }
            else if (cellValue.Equals("LiquidityInvestmentPortfolio"))
            {
                k = 1;
            }
            ...
            else if (cellValue.Equals("CapitalAnalysis"))
            {
                k = 1;
            }
            ...
            else if (cellValue.Equals("OffBalanceSheetCreditRisk"))
            {
                k = 1;
            }
            else if (cellValue.Equals("OffBalanceSheetLIPRrisk"))
            {
                k = 1;
            }
            else if (cellValue.Equals("OffBalanceSheetCreditRisk"))
            ...
            else if (cellValue.Equals("OffBalanceSheetIRrisk"))
            {
                k = 1;
            }
            else if (cellValue.Equals("OffBalanceSheet"))
            ...
            else if (cellValue.Equals("CrConcentrationOfCredit"))
            {
                k = 1;
            }
        ...
        {            
            if (cellValue.Equals("SummaryRatios"))
            {
            ...
            {
                cellValue = "CONCENTRATIONS OF CREDIT";//"CONCENTRATIONS OF CREDIT";
            }
            else if (cellValue.Equals("CrConcentrationOfCredit"))
            {
                cellValue = "CONCENTRATIONS OF CREDIT: LOANS & LEASES";//"CONCENTRATIONS OF CREDIT";
            }
            else if (cellValue.Equals("OffBalanceSheetIRrisk"))
            {
            ...
            {
                cellValue = "COMMERCIAL REAL ESTATE LOANS";//"COMMERCIAL REAL ESTATE";
            }
            else if (cellValue.Equals("KeyLiquidityRatios"))
            {
            ...
            {
                cellValue = "LIQUIDITY/SECURITIES RATIOS"; //"LIQUIDITY SECURITY RATIOS";
            }
            else if (cellValue.Equals("OffBalanceSheetCreditRisk"))
            {
