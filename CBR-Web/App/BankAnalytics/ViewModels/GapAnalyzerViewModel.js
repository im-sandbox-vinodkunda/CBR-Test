...
cbrBankAnalyticsModule.controller("gapAnalyzerFinancialHeights", ["$scope", "$q", "$http", "$location", "$routeParams", "$window", "$rootScope", "$filter", "$timeout", function ($scope, $q, $http, $location, $routeParams, $window, $rootScope, $filter, $timeout) {
    ...
    var getInstitutionList = function () {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to fetch favorite institutions. Please send an e-mail to castellonf@stifel.com.');
            });
    }
    ...
    var getFinancialHighlightsData = function () {
        ...
        $http(req).then(
            ...
            function () {
                angular.element(document.querySelector('#financialHighlightsDataLoader')).addClass('hidden');
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to fetch financial highlights data. Please send an e-mail to castellonf@stifel.com.');
            });
    }
    ...
    $scope.ResetBenchmark = function () {
        ...
        $http(req).then(
            ...
            function () {
                angular.element(document.querySelector('#financialHighlightsDataLoader')).addClass('hidden');
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to reset benchmarks. Please send an e-mail to castellonf@stifel.com.');
            });
    }
    ...
    $scope.UpdateBenchmark = function (earningsAndPerfItem) {
        ...
        $http(req).then(
            ...
            function () {
                angular.element(document.querySelector('#financialHighlightsDataLoader')).addClass('hidden');
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to update benchmark. Please send an e-mail to castellonf@stifel.com.');
            });
    }
...
cbrBankAnalyticsModule.controller("gapAnalyzerLoansAndLeases", ["$scope", "$q", "$http", "$location", "$routeParams", "$window", "$rootScope", "$filter", "$timeout", function ($scope, $q, $http, $location, $routeParams, $window, $rootScope, $filter, $timeout) {
    ...
    var getCurrentPeriod = function () {
        ...
        $http(req).then(
            ...
            function () {
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to get current period date. Please send an e-mail to castellonf@stifel.com.');
            });
    }
    ...
    var getLoansLeasesData = function () {
        ...
        $http(req).then(
            ...
            function () {
                angular.element(document.querySelector('#loansLeasesDataLoader')).addClass('hidden');
                $scope.toggleErrorMessageBoxModal('An error occurred while trying to fetch loand and leases data. Please send an e-mail to castellonf@stifel.com.');
            });
    }
