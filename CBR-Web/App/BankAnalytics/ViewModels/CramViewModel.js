...
cbrBankAnalyticsModule.controller("cramDashboardLinksViewModel", ["$scope", "$q", "$http", "$location", "$routeParams", "$window", "$rootScope", "$filter", "$timeout", function ($scope, $q, $http, $location, $routeParams, $window, $rootScope, $filter, $timeout) {
            ...
            if ($scope.CramModels.length > 0) {
                ...
                if (selectedModel === null) {
                    ...
                    $http(req).then(function (result) {
                        ...
                        $scope.toggleErrorMessageBoxModal('An error occurred while trying to save or update model. Please send an e-mail to castellonf@stifel.com.');
                        //angular.element(document.querySelector('#bankSearchLoader')).attr('style', 'display:none');
                    });
                }
            }
    ...
    var SaveOrUpdateRiskCategories = function () {
        ...
        $http(req).then(function (result) {
            ...
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to save risk categories and weights. Please send an e-mail to castellonf@stifel.com.');
            //angular.element(document.querySelector('#bankSearchLoader')).attr('style', 'display:none');
        });
    }
    ...
    var getCramDashboardConcepts = function (bankKey, period) {
        ...
        $http(req).then(function (result) {
            ...
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to get dashboard concepts. Please send an e-mail to castellonf@stifel.com.');
        });
    }
    ...
    var GetModelsForUser = function (selectModelKey) {
        ...
        $http(req).then(function (result) {
            ...
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to get models. Please send an e-mail to castellonf@stifel.com.');
        });
    }
    ...
    var GetUserInfo = function () {
        ...
        $http(req).then(function (result) {
            ...
            angular.element(document.querySelector('#loaderDashboardLinks')).addClass('hidden');
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to get user information. Please send an e-mail to castellonf@stifel.com.');
        });
    }
    ...
    var getDefaultRatings = function () {
        ...
        $http(req).then(function (result) {
            ...
            angular.element(document.querySelector('#loaderDashboardLinks')).addClass('hidden');
            $scope.toggleErrorMessageBoxModal('An error occurred while trying to get default ratings. Please send an e-mail to castellonf@stifel.com.');
        });
    }
    ...
    var getPastFiveQuarters = function () {
        ...
        $http(req).then(function (result) {
            ...
            angular.element(document.querySelector('#loaderDashboardLinks')).addClass('hidden');
            $scope.toggleErrorMessageBoxModal('An error occurred while loading the financial periods. Please send an e-mail to castellonf@stifel.com.');
        });
    }
